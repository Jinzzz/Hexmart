...
class ProductController extends Controller
{
    ...
    */
    public function productlist($name)
    {
        ...
        return view('customer.product.productlist', compact('navCategoryDetails', 'product', 'product_varient','min','max'));
    }
    ...
    */
    public function productcatlist($name, $catname)
    {
        ...
        else
        {
            ...
            {
                $subcat_product_varient = Mst_ProductVariant::with('Productvarients')->whereIn('variant_name', $data)->orderBy('variant_name', 'asc')->take(2)->paginate($pageinationval);
            ...
            return view('customer.product.productcat1', compact('navCategoryDetails', 'product', 'subcat_product_varient','min','max'));
    ...
    */
    public function mainsubcatgeory($name, $catname, $mainsubcat)
    {
        ...
        else
        {
            ...
            {
                $mainsub_product_varient = Mst_ProductVariant::with('Productvarients')->whereIn('variant_name', $data)->orderBy('variant_name', 'asc')->take(2)->paginate($main_pageinationval);
            ...
            return view('customer.product.productcat2', compact('navCategoryDetails', 'product', 'mainsub_product_varient','min','max'));
