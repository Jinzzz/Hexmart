              ...
              <input type="hidden" name="id" value="{{$address->customer_address_id}}">
                        ...
                        @endif
                           <div class="row">
                              <div class="col-lg-6">
                                 <label>Name</label>
                                 <input type="text" placeholder="Full Name" name="name" required="" autocomplete="off" value="{{$address->name}}">
                              </div>
                              <div class="col-lg-6">
                                 <label>Phone Number</label>
                                 <input type="tel" pattern="[789][0-9]{9}" 
                                 title="Phone number with 7-9 and remaing 9 digit with 0-9" placeholder="Phone number" name="customer_mobile" required="" autocomplete="off" value="{{$address->phone}}">
                              ...
                              <div class="col-lg-6 col-6">
                                 ...
                                 <input type="text" placeholder="Pincode" name="pin" required="" autocomplete="off"  value="{{$address->pincode}}">
                              </div>
                              <div class="col-lg-6 col-6">
                              ...
                              <div class="col-lg-6 col-6">
                                 <label>State</label>
                                 <input type="text" placeholder="State" name="state" required="" autocomplete="off" value="{{$address->state}}">
                              </div >
                              <div class="col-lg-6 col-6">
                                 <label>City</label>
                                 <input type="text" placeholder="City" name="city" id="City" required="" autocomplete="off" value="{{$address->city}}">
                              </div >
                              <div class="col-lg-6">
                                 <label>Address</label>
                                 <input type="text" placeholder="House No, Building Name" name="place" required="" autocomplete="off" value="{{$address->house}}">
                              </div >
                              <div class="col-lg-6">
                                 <label>Landmark</label>
                                 <input type="text" placeholder="Road name, Area, Colony" name="road" required="" autocomplete="off" value="{{$address->street}}">
