         ...
         <div class="topheader pt-3 pb-3">
            ...
            <div class="cart-account">
               <div class="dropdown d-down pt-3">
                  ...
                  <div class="dropdown-content drp-m"> <a href="{{url('/customer/register')}}">Register</a> <a href="{{url('/customer/customer-login')}}">Login</a> <a href="{{url('/customer/logout')}}" >logout</a> </div>
               </div>
            </div>
            <div class="">
