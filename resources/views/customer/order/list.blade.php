   ...
   <div class="container-fluid">
      <div class="myorder-container">
         <div class="row">
            ...
            <div class="col-lg-12">
               <a href="{{url('customer/Order-Details').'/'.$val->order_id }}">
                  <div class="myorderconfrm-div">
                     <div class="myorderconfrm">
                        <h4>Order no. @if(isset($val->order_number)){{$val->order_number}}@endif</h4>
                       @if(isset($val->order_status_id))
                           <span class="badge  badge-pill badge-info float-right">{{ @$val->orderStatusData->status }}</span>
                        @else
