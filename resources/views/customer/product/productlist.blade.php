         ...
         <div class="pagediv-main2">
            <div class="right-side">
               <div class="row">
                  <div class="col-lg-12">
                     <div class="pagelinks">
                        <ul>
                           ...
                           <li>{{ucfirst($name)}} <span><i class="fa fa-angle-right" aria-hidden="true"></i></span></li>
                        </ul>
                     </div>
                  </div>
                  <div class="col-lg-12">
                  ...
                  </div> @foreach($product_varient as $varient)
                  <div class="col-lg-12 ptre">
                     <div class="maindicproduct">
                        <div class="primag"> <a href="{{url('/productdetail').'/'.$name.'/'.$varient->variant_name}}"><img src="{{asset( (new \App\Helpers\Helper)->productVarBaseImage($varient->product_id,$varient->product_variant_id))}}"   width="50" ></a> </div>
                        <div class="prdetails">
                           <h3>{{ucfirst($varient->variant_name)}} </h3>
                           <ul> @if(isset($varient->Productvarients[0]->product_description)) {!! substr(strip_tags($varient->Productvarients[0]->product_description), 0, 100) !!}@endif </ul>
                        </div>
                        <div class="pramount">
               ...
               <div class="pageination-div">
                  ...
                  <div class="pagination-news-page">
                     <nav aria-label="Page navigation example">
                        <ul class="pagination">
                           <li> {{ $product_varient->appends(request()->input())->links()}} </li>
                        </ul>
                     </nav>
                  </div>
               </div>
