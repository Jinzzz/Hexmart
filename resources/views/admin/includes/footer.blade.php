...
<!-- NOTIFICATIONS JS -->
		<script src="{{URL::to('/assets/plugins/notify/js/rainbow.js')}}"></script>
		<script src="{{URL::to('/assets/plugins/notify/js/sample.js')}}"></script>
		<script src="{{URL::to('/assets/plugins/notify/js/jquery.growl.js')}}"></script>
