                                 ...
                                 <tr>
                                    ...
                                    <td>
                                        @if(isset($category->sub_category_icon))
                                            <img src="{{asset('assets/uploads/category_icon/'.$category->sub_category_icon)}}"  width="50" >
                                        @else
                           ...
                           <table class="table row table-borderless">
                              <tbody class="col-lg-12 col-xl-12 p-0">
                                 ...
                                 <tr>
                                    ...
                                    @if(isset($category->sub_category_icon))
                                    <img src="{{asset('assets/uploads/category_icon/'.$category->sub_category_icon)}}"  width="130px" >
                                    @else
                                    <img src="{{ (new \App\Helpers\Helper)->categoryIcon() }}"  width="50" >
                                    @endif
