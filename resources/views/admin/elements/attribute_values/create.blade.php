            ...
            <div class="card-body">
               ...
               @endif
                ...
                <div class="col-lg-12">
                    ...
                    @endif
                    <form action="{{route('admin.store_attribute_value')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                        <div class="row">
                                  ...
                                  <label class="form-label">Attribute Group *</label>
                                   <select required class="form-control" name="attribute_group_id" id="attribute_group_id">
                                      <option value="">Attribute Group</option>
                                         ...
                                         <option {{old('attribute_group_id') == $key->attribute_group_id ? 'selected':''}} value=" {{ $key->attribute_group_id}} "> {{ $key->attribute_group }}</option>
                                         @endforeach
                                   </select>
                                </div>
                             </div> 
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="text" class="form-control" name="attribute_value" value="{{old('attribute_value')}}" placeholder="Attribute Value">
                                </div>
                            </div>
