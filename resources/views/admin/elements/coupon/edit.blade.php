      ...
      <div class="col-md-12">
         <div class="card">
            ...
            <div class="col-lg-12">
               ...
               @endif
               <form action="{{route('admin.update_coupon',$coupon->coupon_id)}}" method="POST"  enctype="multipart/form-data">
                  @csrf
                  <div class="row">
                        <div class="col-md-6">
                    ...
                    <div class="form-group">
                           ...
                           <a class="btn btn-danger" href="{{ route('admin.list_coupon') }}">Cancel</a>
                           </center>
                        </div>
               </form>
