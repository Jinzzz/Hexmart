                    ...
                    <div class="col-md-12">
                     ...
                     <div class="col-md-2">
                        <label class="custom-switch">
                            ...
                            <input type="checkbox" name="is_active" @if ($tax->is_active == 1)
                            checked
                        ...
                        <div class="card-body">
                                <table class="table table-bordered  ">
                                    <tbody class="bodyClass">
                                        ...
                                        <tr>
                                            <td>
                                                <input  type="text" required name="split_tax_name[]" id="split_tax_name0" value="{{ $split->tax_split_name }}"  class=".split_name form-control" placeholder="Tax Name" >
                                            </td>
                                            <td>
                                                <input step="0.01" type="number" required oninput="valueChanged(this.id)" value="{{ $split->tax_split_value }}" name="split_tax_value[]" id="split_tax_name0" class="split_value form-control" placeholder="Tax Value(%)" >
                                            </td>
