                        ...
                        <div class="table-responsive ">
                           <table class="table row table-borderless">
                              <tbody class="col-lg-12 col-xl-12 p-0">
                                 ...
                                 <tr>
                                    <td><h6>Customer name: </td><td> {{ $row->customer_name }}</h6></td>
                                 </tr>

                                 <tr>
                                  <td><h6>Customer mobile: </td><td> {{ $row->customer_mobile }}</h6></td>
                                  </tr>
                                  ...
                                  <tr>
                                    <td><h6>Customer gender: </td><td> {{ $row->customer_gender }}</h6></td>
                                  </tr>

                                  <tr>
                                    <td><h6>Customer dob: </td><td> {{ $row->customer_dob }}</h6></td>
                                  </tr>
