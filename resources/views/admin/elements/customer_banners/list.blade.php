                                ...
                                <table id="example" class="table table-striped table-bordered text-nowrap w-100">
                                    <thead>
                                        <tr>
                                            ...
                                            {{-- <th class="wd-20p">Default <br> Status</th> --}}
                                    ...
                                    <tbody >
                                        ...
                                        <tr>
                                            <td>{{ ++$i }}</td>
                                            <td>
                                                <img src="{{asset('assets/uploads/customer_banners/'.$row->customer_banner)}}"  width="70" >
                                            </td>
                                            {{-- <td>
                                                @if($row->is_default == 0)
                                                    Inactive
                           ...
                           <table class="table row table-borderless">
                              <tbody class="col-lg-12 col-xl-12 p-0">
                                 ...
                                 <tr>
                                        ...
                                        <img src="{{asset('assets/uploads/customer_banners/'.$row->customer_banner)}}"  width="150" >
